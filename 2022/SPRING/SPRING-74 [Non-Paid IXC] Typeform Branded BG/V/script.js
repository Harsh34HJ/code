(function() {
    try {
        /* main variables */
        var debug = 0;
        var variation_name = "SPRING-74 IXC V1";
        ...
        function sendData(email) {
            ...
            var redirectURL = "https://springboardedu.typeform.com/to/MlioWIPF?referral=" + l[0] + "&referral2=" + l[1] + "&segmentanonymousid=" + getSegmentAnonymousId() + "&variationid=" + i + "&gclid=" + gclid + "&email=" + data.email + "" + "&uuid=" + feuuid + "&" + utmParam;;;
