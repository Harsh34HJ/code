...
var i = parseInt(window.pageYOffset);
  ...
  function spring77(){
  	...
  	if(!document.querySelector('[class^="styles__SecondaryNavWrapper-sc"] .new-banner')){
	    ...
	    var sticky = header.offsetTop;
		  ...
		  if (window.pageYOffset > sticky) {
		    document.querySelector('.fe-tech-sales-page [class^="styles__SecondaryNavWrapper-sc"]').classList.add("sticky");
		  } else {
		    document.querySelector('.fe-tech-sales-page [class^="styles__SecondaryNavWrapper-sc"]').classList.remove("sticky");
		  }
  	    }; 
  	}
  	...
  	updateInnerHtml(document.querySelectorAll('.hyOIzs .pricePreview .description')[0], 'Pay upfront & save 37% on tuiton');
	updateInnerHtml(document.querySelectorAll('.hyOIzs .pricePreview .description')[1], 'Pay for the months you need. Save up to 24%.');
	updateInnerHtml(document.querySelectorAll('.hyOIzs .pricePreview .description')[2], 'Fixed cost after you start a job. No percentage of income.');
  }
