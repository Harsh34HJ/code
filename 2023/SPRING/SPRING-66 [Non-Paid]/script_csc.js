(function () {
    try {
     ...
     function live(selector, event, callback, context) {
      ...
      waitForElement('div[class^="styles__SecondaryNavWrapper"] .ctaWrapper .request-syllabus-form', init2, 100, 35000);
    } catch (e) {
      if (debug) console.log(e, "error in Test" + variation_name);
    }
  })();
  /* EDITELEMENT */
  vwo_$(".ctasWrapper > a:nth-of-type(1) > button:nth-of-type(1)").html("Call +1 415 966 2533");
