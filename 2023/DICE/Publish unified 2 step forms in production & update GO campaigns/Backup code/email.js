    ...
    try {
        ...
        function neverbounceValidate() {
            ...
            document.querySelector('body').addEventListener('nb:registered', function(event) {
                document.getElementsByClassName('.mktoButtonWrap button').disabled = true;
                ...
                field.addEventListener('nb:result', function(e) {
                    if (e.detail.result.is(_nb.settings.getAcceptedStatusCodes())) {
                        ...
                        document.getElementsByClassName('.mktoButtonWrap button').disabled = false;
                        //e.preventDefault();
                    } else {
                ...
                onLoadMktoForms2(function() {
                    MktoForms2.whenReady(function(form) {
                        ...
                        form.onValidate(function(isValid){
                        	emailCheck(form);
                            //console.log('isValid',isValid,'isEmailValid',isEmailValid);
