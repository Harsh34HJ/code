...
(function () {
        ...
        triggerNextStep: function (steps, formRow, formLabel) {
            setTimeout(function () {
                ...
                /*if (isValid && step === 1 && isLastNameValid) {*/
                    ...
                    newTrackGAEvent("funnelenvy", "click", "Email Entered");
                    newTrackGAEvent("GA_Step_1_complete", "GA-Clicks", "Step_1_complete");
                ...
                if (true) {
                    ...
                    var interval = setInterval(function() {
				        ...
				        if (element && !document.querySelector(".mktoForm input").value.length == 0) {
				            clearInterval(interval);
                            element.reset();
                            var cookiePresent = getCookie("formdata");
		                    if (cookiePresent != "") {
				                setCookie("formdata","",0);
		                    }
				        }
                    },500);
                    // change button text
                    ...
                    // form field
                    var formRow = document.querySelectorAll("form[id*='mktoForm'] .mktoFormRow.fe_step1");
                    ...
                    form.onSuccess(function () {
                        newTrackGAEvent("GA_Step_2_complete", "GA-Clicks", "Step_2_complete");
    ...
    function newTrackGAEvent(eventCategory, eventAction, eventLabel) {
        if ("ga" in window) {
